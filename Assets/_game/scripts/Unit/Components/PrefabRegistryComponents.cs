...
namespace CitySim
{
    ...
    public struct PrefabLookup : IComponentData
    {
        ...
        public NativeHashMap<int2, Entity> RoadMap;   // (RoadDirections, VariantKey) -> Entity
        ...
        public bool TryGetRoad(byte directions, int variantKey, out Entity prefab)
        {
            return RoadMap.TryGetValue(new int2(directions, variantKey), out prefab);
        }
    ...
    public struct MapLoadState : IComponentData
    {
        ...
        public int           MissingMainKey;
        public int           MissingVariantKey;
        public int           MissingRoadDirections;
    }
    ...
    public struct PrefabMetaEntry : IBufferElementData
    {
        ...
        public PrefabDomain Domain;
        public PrefabPurposeFlags PurposeFlags;
        public int RequiredTechLevel;
        public MapTerrainMask AllowedTerrains;
        public PlacementRuleFlags PlacementRules;
    }
